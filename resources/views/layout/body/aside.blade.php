<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        @if (auth()->user()->userRoles()->first()->role->name == 'Admin')
            <a href="{{ route('admin.auth.home') }}" class="app-brand-link">
        ...
        @elseif(auth()->user()->userRoles()->first()->role->name == 'Guest')
            <a href="{{ route('guest.auth.home') }}" class="app-brand-link">
                <span class="app-brand-logo demo">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                @elseif(auth()->user()->userRoles()->first()->role->name == 'Guest')
                    <li class="menu-item">
                        <a href="{{ route('guest.roles.index') }}" class="menu-link">
                            <div data-i18n="Account">Roles</div>
                        </a>
                    </li>
                    <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="{{ route('admin.calendars.index', $academic_period->name) }}" class="menu-link">
