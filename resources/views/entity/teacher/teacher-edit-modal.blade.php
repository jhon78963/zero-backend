<div class="modal fade" id="editTeacherModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <form id="editTeacherForm">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Editar Profesor</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btnUpdateTeacher">Actualizar</button>
                </div>
            </div>
        </form>
    </div>
