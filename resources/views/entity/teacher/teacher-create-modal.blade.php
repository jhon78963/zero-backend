<div class="modal fade" id="createTeacherModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <form id="createTeacherForm">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Registrar Profesor</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btnCreateTeacher">Registrar</button>
                </div>
            </div>
        </form>
    </div>
